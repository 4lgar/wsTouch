...
function init() {
    ...
    if (ctx) {
        ...
        window.addEventListener('mousedown', sketchpad_mouseDown, false);
        window.addEventListener('mousemove', sketchpad_mouseMove, false);
        window.addEventListener('mouseup', sketchpad_mouseUp, false);

        // React to touch events on the canvas
        window.addEventListener('touchstart', sketchpad_touchStart, false);
        window.addEventListener('touchmove', sketchpad_touchMove, false);
